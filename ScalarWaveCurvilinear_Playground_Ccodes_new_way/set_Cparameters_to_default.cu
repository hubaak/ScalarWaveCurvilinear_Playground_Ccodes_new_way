 ...
 */
 __host__ void set_Cparameters_to_default(paramstruct *restrict params) {
  ...
  params->AMPL = 10.0;  // reference_metric::AMPL
  params->SINHW = 0.2;  // reference_metric::SINHW
  params->wavespeed = 1.0;  // ScalarWave.CommonParams::wavespeed
  params->time = 0;  // ScalarWave.InitialData::time
  params->kk0 = 1;  // ScalarWave.InitialData::kk0
  params->kk1 = 1;  // ScalarWave.InitialData::kk1
  params->kk2 = 1;  // ScalarWave.InitialData::kk2
