...
typedef struct __paramstruct__ {
  REAL AMPL;  // reference_metric::AMPL
  ...
  REAL SINHW;  // reference_metric::SINHW
  REAL dxx0;  // grid::dxx0
  REAL dxx1;  // grid::dxx1
  REAL dxx2;  // grid::dxx2
  ...
  REAL kk0;  // ScalarWave.InitialData::kk0
  REAL kk1;  // ScalarWave.InitialData::kk1
  REAL kk2;  // ScalarWave.InitialData::kk2
  REAL time;  // ScalarWave.InitialData::time
...
///added
#define IN_REGION(x, xmin, xmax) (((x) >= (xmin)) && ((x) < (xmax)))
