...
__host__ void MoL_step_forward_in_time(griddata_struct *restrict griddata, const REAL dt);
__global__ void MoL_step_forward_in_time_GPU(griddata_struct *restrict griddata, const REAL dt, REAL *restrict tmp_gm);
__host__ void set_bcstruct(const paramstruct *restrict params,
                  gz_map *restrict bc_gz_map,
                  parity_condition *bc_parity_conditions,
                  bc_struct *restrict bcstruct);
__host__ void driver_bcstruct(const paramstruct *restrict params, bc_struct *restrict bcstruct, REAL *restrict xx[3]);
__host__ void apply_bcs_curvilinear_inner_only(const paramstruct *restrict params, const bc_struct *restrict bcstruct,
...
__host__ REAL find_timestep(const paramstruct *restrict params, REAL *restrict xx[3], const REAL CFL_FACTOR);
...
__host__ void set_Nxx_dxx_invdx_params__and__xx(const int EigenCoord, const int Nxx[3],paramstruct *restrict params, REAL *restrict xx[3]);
...
__host__ void set_Cparameters_to_default(paramstruct *restrict params);
