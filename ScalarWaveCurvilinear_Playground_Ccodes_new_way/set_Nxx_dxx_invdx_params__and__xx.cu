...
#include "./set_Cparameters.h"
    ...
    cudaMallocManaged((void **)&(xx[0]), sizeof(REAL)*Nxx_plus_2NGHOSTS0, cudaMemAttachGlobal);  
    ...
    cudaMallocManaged((void **)&(xx[1]), sizeof(REAL)*Nxx_plus_2NGHOSTS1, cudaMemAttachGlobal);  
    ...
    cudaMallocManaged((void **)&(xx[2]), sizeof(REAL)*Nxx_plus_2NGHOSTS2, cudaMemAttachGlobal);  
