...
__host__ void set_up__bc_gz_map_and_parity_condns(const paramstruct *restrict params,
...
#define EPS_ABS 1e-8
    if(fabs( (double)(xCart_orig[0] - xCart[0]) ) > EPS_ABS ||
       ...
       fprintf(stderr,"Error. SinhSpherical: Cartesian disagreement: ( %.15e %.15e %.15e ) != ( %.15e %.15e %.15e ) | xx: %e %e %e -> %e %e %e | %d %d %d\n",
               (double)xCart_orig[0],(double)xCart_orig[1],(double)xCart_orig[2],
               (double)xCart[0],(double)xCart[1],(double)xCart[2],
    ...
    if(i0_inbounds-i0 == 0 && i1_inbounds-i1 == 0 && i2_inbounds-i2 == 0) {
      ...
      // Documented in: Tutorial-Start_to_Finish-Curvilinear_BCs.ipynb
         ...
         *    REAL_parity_array[1] = sin(xx1)*sin(xx1_inbounds)*sin(xx2)*sin(xx2_inbounds) + sin(xx1)*sin(xx1_inbounds)*cos(xx2)*cos(xx2_inbounds) + cos(xx1)*cos(xx1_inbounds),
         *    REAL_parity_array[2] = sin(xx1)*sin(xx1_inbounds) + sin(xx2)*sin(xx2_inbounds)*cos(xx1)*cos(xx1_inbounds) + cos(xx1)*cos(xx1_inbounds)*cos(xx2)*cos(xx2_inbounds),
         *    REAL_parity_array[3] = sin(xx2)*sin(xx2_inbounds) + cos(xx2)*cos(xx2_inbounds),
         *    REAL_parity_array[4] = (sin(xx1)*sin(xx1_inbounds)*sin(xx2)*sin(xx2_inbounds) + sin(xx1)*sin(xx1_inbounds)*cos(xx2)*cos(xx2_inbounds) + cos(xx1)*cos(xx1_inbounds))**2,
         *    REAL_parity_array[5] = (sin(xx1)*sin(xx1_inbounds) + sin(xx2)*sin(xx2_inbounds)*cos(xx1)*cos(xx1_inbounds) + cos(xx1)*cos(xx1_inbounds)*cos(xx2)*cos(xx2_inbounds))*(sin(xx1)*sin(xx1_inbounds)*sin(xx2)*sin(xx2_inbounds) + sin(xx1)*sin(xx1_inbounds)*cos(xx2)*cos(xx2_inbounds) + cos(xx1)*cos(xx1_inbounds)),
         *    REAL_parity_array[6] = (sin(xx2)*sin(xx2_inbounds) + cos(xx2)*cos(xx2_inbounds))*(sin(xx1)*sin(xx1_inbounds)*sin(xx2)*sin(xx2_inbounds) + sin(xx1)*sin(xx1_inbounds)*cos(xx2)*cos(xx2_inbounds) + cos(xx1)*cos(xx1_inbounds)),
         *    REAL_parity_array[7] = (sin(xx1)*sin(xx1_inbounds) + sin(xx2)*sin(xx2_inbounds)*cos(xx1)*cos(xx1_inbounds) + cos(xx1)*cos(xx1_inbounds)*cos(xx2)*cos(xx2_inbounds))**2,
         *    REAL_parity_array[8] = (sin(xx2)*sin(xx2_inbounds) + cos(xx2)*cos(xx2_inbounds))*(sin(xx1)*sin(xx1_inbounds) + sin(xx2)*sin(xx2_inbounds)*cos(xx1)*cos(xx1_inbounds) + cos(xx1)*cos(xx1_inbounds)*cos(xx2)*cos(xx2_inbounds)),
         ...
         */
        {
          ...
          REAL_parity_array[0] = 1;
          REAL_parity_array[1] = tmp_4;
          REAL_parity_array[2] = tmp_5;
          REAL_parity_array[3] = tmp_6;
          REAL_parity_array[4] = ((tmp_4)*(tmp_4));
          REAL_parity_array[5] = tmp_4*tmp_5;
          REAL_parity_array[6] = tmp_4*tmp_6;
          REAL_parity_array[7] = ((tmp_5)*(tmp_5));
          REAL_parity_array[8] = tmp_5*tmp_6;
          REAL_parity_array[9] = ((tmp_6)*(tmp_6));
        }
