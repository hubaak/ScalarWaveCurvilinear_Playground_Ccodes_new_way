...
const REAL AMPL = params->AMPL;  // reference_metric::AMPL
const REAL SINHW = params->SINHW;  // reference_metric::SINHW
const REAL wavespeed = params->wavespeed;  // ScalarWave.CommonParams::wavespeed
const REAL time = params->time;  // ScalarWave.InitialData::time
const REAL kk0 = params->kk0;  // ScalarWave.InitialData::kk0
const REAL kk1 = params->kk1;  // ScalarWave.InitialData::kk1
const REAL kk2 = params->kk2;  // ScalarWave.InitialData::kk2
