...
#include "./set_Cparameters.h"
  ...
  cudaMallocManaged((void **)&(bc_gz_map), sizeof(gz_map)*Nxx_plus_2NGHOSTS_tot, cudaMemAttachGlobal);
  ...
  cudaMallocManaged((void **)&(bc_parity_conditions), sizeof(parity_condition)*Nxx_plus_2NGHOSTS_tot, cudaMemAttachGlobal);
  ...
  cudaMallocManaged((void **)&(bcstruct->outer), sizeof(outer_bc *)*NGHOSTS, cudaMemAttachGlobal);
  cudaMallocManaged((void **)&(bcstruct->inner), sizeof(inner_bc *)*NGHOSTS, cudaMemAttachGlobal);
  cudaMallocManaged((void **)&(bcstruct->num_ob_gz_pts), sizeof(int)*NGHOSTS, cudaMemAttachGlobal);
  cudaMallocManaged((void **)&(bcstruct->num_ib_gz_pts), sizeof(int)*NGHOSTS, cudaMemAttachGlobal);
