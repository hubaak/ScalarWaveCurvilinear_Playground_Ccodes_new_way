...
const REAL            NOSIMDAMPL = params->AMPL;  // reference_metric::AMPL
const REAL_SIMD_ARRAY AMPL = ConstSIMD(NOSIMDAMPL);  // reference_metric::AMPL
const REAL            NOSIMDSINHW = params->SINHW;  // reference_metric::SINHW
const REAL_SIMD_ARRAY SINHW = ConstSIMD(NOSIMDSINHW);  // reference_metric::SINHW
...
const REAL            NOSIMDtime = params->time;  // ScalarWave.InitialData::time
const REAL_SIMD_ARRAY time = ConstSIMD(NOSIMDtime);  // ScalarWave.InitialData::time
const REAL            NOSIMDkk0 = params->kk0;  // ScalarWave.InitialData::kk0
const REAL_SIMD_ARRAY kk0 = ConstSIMD(NOSIMDkk0);  // ScalarWave.InitialData::kk0
const REAL            NOSIMDkk1 = params->kk1;  // ScalarWave.InitialData::kk1
const REAL_SIMD_ARRAY kk1 = ConstSIMD(NOSIMDkk1);  // ScalarWave.InitialData::kk1
const REAL            NOSIMDkk2 = params->kk2;  // ScalarWave.InitialData::kk2
const REAL_SIMD_ARRAY kk2 = ConstSIMD(NOSIMDkk2);  // ScalarWave.InitialData::kk2
